...
CREATE TABLE Account (
    ...
    phoneNumber    VARCHAR2(20) CHECK (
        REGEXP_LIKE(phoneNumber, '[[:digit:]]{9,10}|[[:digit:]]{3}-[[:digit:]]{3}-[[:digit:]]{4}')
    ),
...
CREATE TABLE PromotionTargets (
    ...
    targetValue     VARCHAR2(100) NOT NULL
);

-- Add columns to StorePromotions
...
-- Trigger to auto-update order amount
