...
CREATE TABLE Genre (
    movieID      NUMBER,
    genre        VARCHAR2(50),
    CONSTRAINT MovieGenre PRIMARY KEY (movieID, genre),
    CONSTRAINT fk_movie_genre FOREIGN KEY (movieID) REFERENCES Movie(movieID)
);

CREATE TABLE MovieCast (
    movieID      NUMBER,
    actorName    VARCHAR2(50),
    CONSTRAINT MovieCast PRIMARY KEY (movieID, actorName),
    CONSTRAINT fk_movie_cast FOREIGN KEY (movieID) REFERENCES Movie(movieID)
);

CREATE TABLE MovieDirector (
    movieID      NUMBER,
    DirectorName    VARCHAR2(50),
    CONSTRAINT MovieDirector PRIMARY KEY (movieID, DirectorName),
    CONSTRAINT fk_movie_director FOREIGN KEY (movieID) REFERENCES Movie(movieID)
);
